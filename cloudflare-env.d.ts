/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 52d421471d32d56bd620ac0e1604a9b8)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 enable_request_signal,global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	CACHE: KVNamespace;
	DB: D1Database;
	JOBS_RATE_LIMITER: RateLimit;
	FILTERS_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "FRESHNESS_DAYS">> {}
}
